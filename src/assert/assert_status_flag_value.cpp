...
bool assert_status_flag_value::test(emulation_devices *device, condition_status_flag status_flag_def, vector<string> &errors)
{
    ...
    return assert_equal::test(
        ...
        "Register [" + string(register_type_name_map[register_type::Status]) + " (" + status_flag_def.get_name() + ")]",
        errors);
}
