    ...
    case json::value_t::object:
    {
        ...
        if (value["type"].is_string())
            ...
            case value_type::REGISTER_A:
                return device->get_cpu()->get_register8(register_type::A);
            case value_type::REGISTER_X:
                return device->get_cpu()->get_register8(register_type::X);
            case value_type::REGISTER_Y:
                return device->get_cpu()->get_register8(register_type::Y);
            case value_type::REGISTER_P:
                return device->get_cpu()->get_register8(register_type::P);
            }
        break;
    }
